...
firearms_100 = []
countries = []
similar = ["Canada", "England and Wales", "Japan", "South Korea", "France", "Germany", "Switzerland",
           "Ireland", "China", "Singapore", "Hungary", 'Israel', "Taiwan", "Iceland", "Spain", "Belgium",
...
# y = [p[0] * y ** 2 + p[1] * y + p[2] for y in x]  # 2nd order (if it were exponential)
