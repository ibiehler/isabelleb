...
# copy a list
my_copy = my_names  # No!!! Won't make a copy; stop it!
my_copy.append("Gil")
print(my_copy)
print(my_names)
...
end_of_list = my_names.pop()  # pops of end AND RETURNS IT
print(my_names)
print(end_of_list)
...
# FOR EACH only looks at a copy of the list
for item in my_list:
    item += 1
    print(item)
...
my_list = [x for x in range(101) if (x ** 2) % 2 == 0]
...
for i in range(100):
    my_new_list.append(random.randrange(1, 7))
...
# roll two die and them to a list
my_list = []
...
first = "Francis"
last = "Parker"
print(first[0])  # prints F
first = first.upper()  # makes all letters uppercase
print(first + last)
print(last[-2:])  # prints er

for letter in first:  # prints letters individually on own lines
    print(letter)
